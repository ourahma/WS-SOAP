 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ourahma.net/", wsdlLocation = "http://localhost:9090/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ourahma.net/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ourahma.net/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ourahma.net/", "BanqueServicePort"), BanqueService.class, features);
    }
