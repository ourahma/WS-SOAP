...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDH_QNAME = new QName("http://ourahma.net/", "ConversionEuroToDH");
    private static final QName _ConversionEuroToDHResponse_QNAME = new QName("http://ourahma.net/", "ConversionEuroToDHResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ourahma.net/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ourahma.net/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ourahma.net/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ourahma.net/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "ConversionEuroToDH")
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "ConversionEuroToDHResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ourahma.net/", name = "listComptesResponse")
